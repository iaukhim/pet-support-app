...
import com.unknown.supportapp.client.common.service.ticket.LoadManagedTicketsService;
import com.unknown.supportapp.common.dto.ticket.TicketDto;

import java.util.Arrays;
import java.util.List;

public class LoadManagedTicketsImpl implements LoadManagedTicketsService {

    private ExceptionHandler exceptionHandler;

    @Override
    public List<TicketDto> load(int managerId) throws CustomServerError {
        List<TicketDto> ticketsList;

        ServerConnection connection = new ServerConnection();

        JsonNode request = RequestFactory.getFactory().formRequest("load-managed-tickets", "managerId", managerId);
